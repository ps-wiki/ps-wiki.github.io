...
live in `skills/`; private local agent metadata and plans belong in the ignored
`.agents/` directory.
...
It is deployed via [Cloudflare Workers](./worker) and documented using the OpenAPI 3.1.0 specification at <https://api.ps-wiki.ning.guru/openapi.json>
