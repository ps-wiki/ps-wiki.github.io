...
Usage:
  python database/pyscripts/json2md_all.py --in-dir database/json --out-dir _wiki --pattern "*.json" [--fail-fast]

Tip: put this behind a CI job to regenerate pages whenever JSON changes.
"""
