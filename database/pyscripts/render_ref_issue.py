...
def render_issue_body(
    ...
    L += [
        ...
        "### Fix guidance",
        "",
        "See [BibTeX URL conventions](AGENTS.md#bibtex-url-conventions) in AGENTS.md for",
        "domain-specific strategies (NERC, NYISO, PJM, general).",
        "",
        "To apply fixes with agent assistance, follow the workflows described in AGENTS.md and skills/.",
        "",
        "---",
        "",
    ]
