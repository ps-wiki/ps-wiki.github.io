...
Source: <d-cite key="kaya2026fifty"></d-cite>

![Fig. 1. Components of power system optimization throughout the entire planning horizon. (from <d-cite key="kaya2026fifty"></d-cite>)](/assets/img/pswiki/power-systems-optimization.jpg)

*Fig. 1. Components of power system optimization throughout the entire planning horizon. (from <d-cite key="kaya2026fifty"></d-cite>)*
