...
![Fig. 13.14 Response to a step change in mechanical power input (from <d-cite key="kundur1994Power"></d-cite>)](/assets/img/pswiki/response-to-a-step-change-in-mechanical-power-input.png)
